...
numericos en varios metodos 
    ...
    /**
     * Metodo para desviacion media simepre con datos simples ahora dm es
     * desviacion media abreviado donde primero ecuentra el promedio y de ahi el
     * abs es para que a cada dato le reste el promedio pero que no de negativo
     * para que asi al obterlo pues lo divide en la cantidad de nuemeros que
     * colocamos.
     *
     */
